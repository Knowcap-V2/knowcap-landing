...
const requirements = [
  'Active Odoo Partner in good standing',
  'Minimum 3 years Odoo implementation experience',
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            The <span className="gradient-text">Odoo Founders Circle</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            I'm not looking for customers. I'm looking for partners. 
            Seven Odoo Partners who want to shape the future of how we manage projects, 
            together.
          </p>
        </motion.div>
